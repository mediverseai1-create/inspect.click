...
export const metadata: Metadata = {
  title: "InspectFlow — AI Inspection & Corrective Action Platform",
  description:
    "InspectFlow turns every failed inspection item into a tracked, assigned, and verified corrective action — so nothing gets lost in a spreadsheet.",
  icons: {
